...
2. [Technologies Used](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#2-technologies-used)
3. [Our Objective](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#3-our-objective)
4. [Project Architecture](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#4-project-architecture)
...
8. [Azure implementation](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#8-azure-implementation)
9. [How to run the experiment](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#9-how-to-run-the-experiment)
10. [Our output to the experiment](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#10-our-output-of-the-experiment)
11. [Describing our result](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#11-describing-our-result)
13. [Consolidated information of our components](https://github.com/nastayeen-abdulmajid/neocortexapi-project2024/blob/master/MyCloudProjectSample-new/Documentation/ML%2022/23%20-%207%20Implement%20UnitTests%20%20for%20AdaptSegments%20-%20Azure%20Cloud%20Implementation-Team_NV.md#12-consolidated-information-of-our-components)

## 1. Introduction
In software engineering project, we focused on automating unit tests for the "adapt segments" method within the Hierarchical Temporal Memory (HTM) framework, specifically targeting Temporal Memory. It involved creating a comprehensive suite of tests to ensure robust functionality, particularly in handling synapse adaptation based on permanence values. The project utilized various data-driven testing approaches to cover all logical possibilities, resulting in 100% code coverage. The successful execution of all test cases ensures the reliability and effectiveness of the HTM's adapt segment algorithm in processing and learning temporal sequences.
  ![image](https://github.com/UniversityOfAppliedSciencesFrankfurt/se-cloud-2023-2024/assets/148900873/6a7bf5ab-d72d-4668-98f4-c350fab246ce)

However, in cloud computing, our project represents a set of interconnected classes and components designed to manage and execute machine learning experiments using Azure cloud resources. The AzureStorageProvider class facilitates operations with Azure Storage, including queue management and blob interactions. The Excel class, utilizing the EPPlus library, handles the creation and updating of Excel files to store experiment results, ensuring data is written and formatted correctly. The ExperimentRequestMessage class structures and tracks experiment requests with data. The Experiment class orchestrates the experiment execution workflow, that integrates various components such as the Excel class and storage providers, and logs results and errors efficiently. Meanwhile, the ExperimentResult class captures detailed results of experiments, designed for use with Azure Table Storage. Additional classes like TestCase and TestDataReader define and manage test case parameters and data loading. Together, these components form a comprehensive system for managing and processing machine learning experiments in a cloud environment.
...
The description of all test cases can be found here:- 
https://github.com/UniversityOfAppliedSciencesFrankfurt/se-cloud-2023-2024/blob/Team_NV/Source/MySEProjectSample/Documentation/Implement_UnitTest_for_AdaptSegment_Method_TeamNV.pdf
